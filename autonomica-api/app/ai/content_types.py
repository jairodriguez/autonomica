...
class ContentStructure(BaseModel):
    ...
    sections: List[str] = Field(description="List of section names for this content type")
    required_sections: List[str] = Field(description="Sections that must be present")
    optional_sections: List[str] = Field(description="Sections that can be omitted")
    word_count_range: tuple[int, int] = Field(description="Min and max word count")
    character_limit: Optional[int] = Field(description="Character limit if applicable")
...
class ContentTransformation(BaseModel):
    ...
    transformation_method: str = Field(description="Method used for transformation")
    complexity: str = Field(description="Simple, Medium, or Complex transformation")
    estimated_time: int = Field(description="Estimated processing time in seconds")
    quality_impact: str = Field(description="High, Medium, or Low quality impact")
