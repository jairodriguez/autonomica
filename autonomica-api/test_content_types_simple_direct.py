#!/usr/bin/env python3
"""
Direct test script for simplified content types module.
"""
...
try:
    # Import directly from the simplified module
    ...
    print("✅ Successfully imported simplified content types module")
    ...
    if transformation:
        ...
        print("❌ Failed to get transformation path")
    
    # Test metadata
    metadata = registry.get_content_type_metadata()
    print(f"✅ Content type metadata: {len(metadata)} types defined")
    
    print("\n🎉 All basic tests passed! The simplified content types module is working correctly.")
